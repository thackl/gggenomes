...
ggsave("emales-p4a.png", p4, width = 10, height = 3, dpi = 100)
```

![](emales-p4a.png)

The links reveal shared regions and their relative orientation across genomes. `flip()` changes how selected genomes are displayed, making the syntenic structure easier to follow.
...
ggsave("emales-p4b.png", p4, width = 10, height = 3, dpi = 100)
```
